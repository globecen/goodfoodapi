...
public class UtilisateurResource {
    ...
    public List<Utilisateur> utilisateurs(@DefaultValue("25") @QueryParam("pageSize") Integer pageSize,
        ...
        utilisateurs = Utilisateur.find("from Utilisateur where emailUtilisateur like '%" + emailUtilisateur
                + "%' and nomUtilisateur like '%" + nomUtilisateur + "%' and prenomUtilisateur like '%"
                + prenomUtilisateur + "%' and numeroTelUtilisateur like '%" + numeroTelUtilisateur + "%'");
    ...
    public List<Adresse_Utilisateur> utilisateurIdAdresse(@PathParam("id") Long id) throws Exception {
        PanacheQuery<Adresse_Utilisateur> adressesU = Adresse_Utilisateur.find(
                "select a.idAdresse, a.numeroAdresse, a.suppNomAdresse, a.villeAdresse, a.codePostal, a.pays from Adresse_Utilisateur a where a.utilisateur = "
                        + id);
