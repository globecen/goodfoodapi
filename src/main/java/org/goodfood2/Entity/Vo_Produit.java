...
/**
 * The persistent class for the Vo_Produits database table.
 * 
 */
@Entity
@Table(name="Vo_Produits")
@NamedQuery(name="Vo_Produit.findAll", query="SELECT v FROM Vo_Produit v")
public class Vo_Produit {
